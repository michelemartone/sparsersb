 ...
 * switch to using bootstrap.sh (instead autogen.sh) and configure.ac with environment variables, so it can be called from pkg install sparsersb-1.0.3.tar.gz 
...
#define RSBOI_VERSION	100003	/* e.g. 100003 means 1.0.3 */
